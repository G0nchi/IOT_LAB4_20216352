...
// LLM: clase generada con asistencia de IA para mapear los campos de detalle de TheMealDB
    ...
    public String getFormattedIngredients() {
        ...
        for (int i = 0; i < ingredients.length; i++) {
            if (ingredients[i] != null && !ingredients[i].trim().isEmpty()) {
                ...
                sb.append("• ").append(measure).append(" ").append(ingredients[i].trim()).append("\n");
            }
        }
